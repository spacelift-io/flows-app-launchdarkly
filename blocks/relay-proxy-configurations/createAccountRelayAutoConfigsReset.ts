...
// Input schema for Create Account Relay Auto Configs Reset
...
// Output schema for Create Account Relay Auto Configs Reset
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Create Account Relay Auto Configs Reset",
  description:
    "Creates create account relay auto configs reset in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/account/relay-auto-configs/${id}/reset`;
