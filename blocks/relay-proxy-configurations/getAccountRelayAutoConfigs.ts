...
// Input schema for Get Account Relay Auto Configs
const inputSchema: Record<string, AppBlockConfigField> = {};

// Output schema for Get Account Relay Auto Configs
const outputSchema = {
  type: "object",
  properties: {
    items: {
...
export default {
  name: "Get Account Relay Auto Configs",
  description: "Retrieves get account relay auto configs in LaunchDarkly",
