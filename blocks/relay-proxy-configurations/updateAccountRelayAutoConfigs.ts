...
// Input schema for Update Account Relay Auto Configs
...
// Output schema for Update Account Relay Auto Configs
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Update Account Relay Auto Configs",
  description: "Updates update account relay auto configs in LaunchDarkly",
