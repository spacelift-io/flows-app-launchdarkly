...
// Input schema for Create Account Relay Auto Configs
...
// Output schema for Create Account Relay Auto Configs
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Create Account Relay Auto Configs",
  description: "Creates create account relay auto configs in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/account/relay-auto-configs`;
