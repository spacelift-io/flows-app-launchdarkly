...
// Input schema for Get Projects Ai Tools
...
// Output schema for Get Projects Ai Tools
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Projects Ai Tools",
  description: "Retrieves get projects ai tools in LaunchDarkly",
  category: "AI Configs",
