...
// Input schema for Update Projects Ai Configs
...
// Output schema for Update Projects Ai Configs
const outputSchema = {
  type: "object",
  properties: {
    _access: {
...
export default {
  name: "Update Projects Ai Configs",
  description: "Updates update projects ai configs in LaunchDarkly",
  category: "AI Configs",
