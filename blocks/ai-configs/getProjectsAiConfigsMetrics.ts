...
// Input schema for Get Projects Ai Configs Metrics
...
// Output schema for Get Projects Ai Configs Metrics
const outputSchema = {
  type: "object",
  properties: {
    inputTokens: {
...
export default {
  name: "Get Projects Ai Configs Metrics",
  description: "Retrieves get projects ai configs metrics in LaunchDarkly",
  category: "AI Configs",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/projects/${projectKey}/ai-configs/${configKey}/metrics`;
