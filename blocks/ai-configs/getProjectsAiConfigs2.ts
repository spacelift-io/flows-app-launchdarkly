...
// Input schema for Get Projects Ai Configs2
...
// Output schema for Get Projects Ai Configs2
const outputSchema = {
  type: "object",
  properties: {
    _access: {
...
export default {
  name: "Get Projects Ai Configs2",
  description: "Retrieves get projects ai configs2 in LaunchDarkly",
  category: "AI Configs",
