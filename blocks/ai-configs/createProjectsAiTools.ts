...
// Input schema for Create Projects Ai Tools
...
// Output schema for Create Projects Ai Tools
const outputSchema = {
  type: "object",
  properties: {
    key: {
...
export default {
  name: "Create Projects Ai Tools",
  description: "Creates create projects ai tools in LaunchDarkly",
  category: "AI Configs",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/projects/${projectKey}/ai-tools`;
