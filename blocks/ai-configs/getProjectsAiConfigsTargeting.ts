...
// Input schema for Get Projects Ai Configs Targeting
...
// Output schema for Get Projects Ai Configs Targeting
const outputSchema = {
  type: "object",
  properties: {
    createdAt: {
...
export default {
  name: "Get Projects Ai Configs Targeting",
  description: "Retrieves get projects ai configs targeting in LaunchDarkly",
  category: "AI Configs",
