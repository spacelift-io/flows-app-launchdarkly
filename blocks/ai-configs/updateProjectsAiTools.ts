...
// Input schema for Update Projects Ai Tools
...
// Output schema for Update Projects Ai Tools
const outputSchema = {
  type: "object",
  properties: {
    key: {
...
export default {
  name: "Update Projects Ai Tools",
  description: "Updates update projects ai tools in LaunchDarkly",
  category: "AI Configs",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { projectKey, toolKey, ...inputData } = input.event.inputConfig;
