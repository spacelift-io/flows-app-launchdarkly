...
// Input schema for Get Projects Ai Configs Model Configs
...
// Output schema for Get Projects Ai Configs Model Configs
const outputSchema = {
  type: "array",
  items: {
    type: "object",
...
export default {
  name: "Get Projects Ai Configs Model Configs",
  description:
    "Retrieves get projects ai configs model configs in LaunchDarkly",
  category: "AI Configs",
