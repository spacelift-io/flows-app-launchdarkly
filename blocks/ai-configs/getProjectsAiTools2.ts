...
// Input schema for Get Projects Ai Tools2
...
// Output schema for Get Projects Ai Tools2
const outputSchema = {
  type: "object",
  properties: {
    key: {
...
export default {
  name: "Get Projects Ai Tools2",
  description: "Retrieves get projects ai tools2 in LaunchDarkly",
  category: "AI Configs",
