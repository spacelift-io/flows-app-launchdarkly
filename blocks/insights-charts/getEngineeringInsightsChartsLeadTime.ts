...
// Input schema for Get Engineering Insights Charts Lead Time
...
// Output schema for Get Engineering Insights Charts Lead Time
const outputSchema = {
  type: "object",
  properties: {
    metadata: {
...
export default {
  name: "Get Engineering Insights Charts Lead Time",
  description:
    "Retrieves get engineering insights charts lead time in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/engineering-insights/charts/lead-time`;
