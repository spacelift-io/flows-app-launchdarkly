...
// Input schema for Get Engineering Insights Charts Flags Stale
...
// Output schema for Get Engineering Insights Charts Flags Stale
const outputSchema = {
  type: "object",
  properties: {
    metadata: {
...
export default {
  name: "Get Engineering Insights Charts Flags Stale",
  description:
    "Retrieves get engineering insights charts flags stale in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/engineering-insights/charts/flags/stale`;
