...
// Input schema for Update Integration Capabilities Flag Import
...
// Output schema for Update Integration Capabilities Flag Import
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Update Integration Capabilities Flag Import",
  description:
    "Updates update integration capabilities flag import in LaunchDarkly",
