...
// Input schema for Get Integration Capabilities Flag Import2
...
// Output schema for Get Integration Capabilities Flag Import2
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Integration Capabilities Flag Import2",
  description:
    "Retrieves get integration capabilities flag import2 in LaunchDarkly",
