...
// Input schema for Update Applications
...
// Output schema for Update Applications
const outputSchema = {
  type: "object",
  properties: {
    flags: {
...
export default {
  ...
  description: "Updates update applications in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { applicationKey, ...inputData } = input.event.inputConfig;
