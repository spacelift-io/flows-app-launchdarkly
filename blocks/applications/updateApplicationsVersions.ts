...
// Input schema for Update Applications Versions
...
// Output schema for Update Applications Versions
const outputSchema = {
  type: "object",
  properties: {
    _access: {
...
export default {
  name: "Update Applications Versions",
  description: "Updates update applications versions in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { applicationKey, versionKey, ...inputData } =
