...
// Input schema for Create Tokens Reset
...
// Output schema for Create Tokens Reset
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Create Tokens Reset",
  description: "Creates create tokens reset in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/tokens/${id}/reset`;
