...
// Input schema for Update Projects Environments
...
// Output schema for Update Projects Environments
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Update Projects Environments",
  description: "Updates update projects environments in LaunchDarkly",
