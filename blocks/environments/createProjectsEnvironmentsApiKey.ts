...
// Input schema for Create Projects Environments Api Key
...
// Output schema for Create Projects Environments Api Key
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Create Projects Environments Api Key",
  description: "Creates create projects environments api key in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/projects/${projectKey}/environments/${environmentKey}/apiKey`;
