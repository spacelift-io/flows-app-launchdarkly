...
// Input schema for Create Projects Environments Mobile Key
...
// Output schema for Create Projects Environments Mobile Key
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Create Projects Environments Mobile Key",
  description:
    "Creates create projects environments mobile key in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/projects/${projectKey}/environments/${environmentKey}/mobileKey`;
