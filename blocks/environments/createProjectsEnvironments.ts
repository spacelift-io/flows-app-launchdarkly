...
// Input schema for Create Projects Environments
...
// Output schema for Create Projects Environments
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Create Projects Environments",
  description: "Creates create projects environments in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/projects/${projectKey}/environments`;
