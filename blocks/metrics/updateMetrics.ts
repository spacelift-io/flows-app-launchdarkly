...
// Input schema for Update Metrics
...
// Output schema for Update Metrics
const outputSchema = {
  type: "object",
  properties: {
    experimentCount: {
...
export default {
  name: "Update Metrics",
  description: "Updates update metrics in LaunchDarkly",
  category: "Metrics",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { projectKey, metricKey, ...inputData } = input.event.inputConfig;
