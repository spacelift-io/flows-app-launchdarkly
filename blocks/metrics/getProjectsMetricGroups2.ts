...
// Input schema for Get Projects Metric Groups2
...
// Output schema for Get Projects Metric Groups2
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Get Projects Metric Groups2",
  description: "Retrieves get projects metric groups2 in LaunchDarkly",
  category: "Metrics",
