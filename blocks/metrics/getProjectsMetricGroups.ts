...
// Input schema for Get Projects Metric Groups
...
// Output schema for Get Projects Metric Groups
const outputSchema = {
  type: "object",
  properties: {
    items: {
...
export default {
  name: "Get Projects Metric Groups",
  description: "Retrieves get projects metric groups in LaunchDarkly",
  category: "Metrics",
