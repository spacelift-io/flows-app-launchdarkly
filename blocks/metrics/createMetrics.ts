...
// Input schema for Create Metrics
    ...
    type: {
      ...
      items: {
        ...
        properties: {
          kind: {
            type: "string",
            enum: ["exact", "canonical", "substring", "regex"],
          },
          url: {
            type: "string",
          },
...
// Output schema for Create Metrics
const outputSchema = {
  type: "object",
  properties: {
    experimentCount: {
    ...
    lastUsedInExperiment: {
      ...
      properties: {
        ...
        timestamp: {
          type: "integer",
          description:
            "Unix timestamp (in milliseconds) of when this metric was last used",
        },
      },
    ...
    lastUsedInGuardedRollout: {
      ...
      properties: {
        name: {
          type: "string",
          description: "The guarded rollout name (flag name)",
        },
        key: {
          type: "string",
          description: "The guarded rollout key (flag key)",
        },
        timestamp: {
          type: "integer",
          description:
...
export default {
  name: "Create Metrics",
  description: "Creates create metrics in LaunchDarkly",
  category: "Metrics",
