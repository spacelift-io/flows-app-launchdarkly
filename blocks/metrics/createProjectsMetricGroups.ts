...
// Input schema for Create Projects Metric Groups
...
// Output schema for Create Projects Metric Groups
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Create Projects Metric Groups",
  description: "Creates create projects metric groups in LaunchDarkly",
  category: "Metrics",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/projects/${projectKey}/metric-groups`;
