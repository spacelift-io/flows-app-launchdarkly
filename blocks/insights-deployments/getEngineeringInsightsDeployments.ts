...
// Input schema for Get Engineering Insights Deployments
...
// Output schema for Get Engineering Insights Deployments
const outputSchema = {
  type: "object",
  properties: {
    totalCount: {
...
export default {
  name: "Get Engineering Insights Deployments",
  description: "Retrieves get engineering insights deployments in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/engineering-insights/deployments`;
