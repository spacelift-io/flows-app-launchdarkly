...
// Input schema for Update Engineering Insights Deployments
...
// Output schema for Update Engineering Insights Deployments
const outputSchema = {
  type: "object",
  properties: {
    id: {
...
export default {
  name: "Update Engineering Insights Deployments",
  description:
    "Updates update engineering insights deployments in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { deploymentID, ...inputData } = input.event.inputConfig;
