...
// Input schema for Create Members Teams
...
// Output schema for Create Members Teams
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Create Members Teams",
  description: "Creates create members teams in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/members/${id}/teams`;
