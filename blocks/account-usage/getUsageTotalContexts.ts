...
// Input schema for Get Usage Total Contexts
...
// Output schema for Get Usage Total Contexts
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Usage Total Contexts",
  description: "Retrieves get usage total contexts in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/usage/total-contexts`;
