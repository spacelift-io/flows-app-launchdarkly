...
// Input schema for Get Usage Experimentation Events
...
// Output schema for Get Usage Experimentation Events
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Usage Experimentation Events",
  description: "Retrieves get usage experimentation events in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/usage/experimentation-events`;
