...
// Input schema for Get Usage Observability Logs
...
// Output schema for Get Usage Observability Logs
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Usage Observability Logs",
  description: "Retrieves get usage observability logs in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/usage/observability/logs`;
