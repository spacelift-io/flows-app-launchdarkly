...
// Input schema for Get Usage Serverside Contexts
...
// Output schema for Get Usage Serverside Contexts
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Usage Serverside Contexts",
  description: "Retrieves get usage serverside contexts in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/usage/serverside-contexts`;
