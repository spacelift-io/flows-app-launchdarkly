...
// Input schema for Get Usage Data Export Events
...
// Output schema for Get Usage Data Export Events
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Usage Data Export Events",
  description: "Retrieves get usage data export events in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/usage/data-export-events`;
