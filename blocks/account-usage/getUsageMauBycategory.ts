...
// Input schema for Get Usage Mau Bycategory
...
// Output schema for Get Usage Mau Bycategory
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Usage Mau Bycategory",
  description: "Retrieves get usage mau bycategory in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/usage/mau/bycategory`;
