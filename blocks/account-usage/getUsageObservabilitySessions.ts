...
// Input schema for Get Usage Observability Sessions
...
// Output schema for Get Usage Observability Sessions
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Usage Observability Sessions",
  description: "Retrieves get usage observability sessions in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/usage/observability/sessions`;
