...
// Input schema for Get Usage Experimentation Keys
...
// Output schema for Get Usage Experimentation Keys
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Usage Experimentation Keys",
  description: "Retrieves get usage experimentation keys in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/usage/experimentation-keys`;
