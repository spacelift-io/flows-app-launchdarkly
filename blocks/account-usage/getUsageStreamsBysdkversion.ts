...
// Input schema for Get Usage Streams Bysdkversion
...
// Output schema for Get Usage Streams Bysdkversion
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Usage Streams Bysdkversion",
  description: "Retrieves get usage streams bysdkversion in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/usage/streams/${source}/bysdkversion`;
