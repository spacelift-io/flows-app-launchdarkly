...
// Input schema for Get Usage Observability Errors
...
// Output schema for Get Usage Observability Errors
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Usage Observability Errors",
  description: "Retrieves get usage observability errors in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/usage/observability/errors`;
