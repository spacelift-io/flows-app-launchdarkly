...
// Input schema for Create Projects Release Policies
...
// Output schema for Create Projects Release Policies
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Create Projects Release Policies",
  description: "Creates create projects release policies in LaunchDarkly",
