...
// Input schema for Update Integrations
...
// Output schema for Update Integrations
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  ...
  description: "Updates update integrations in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { integrationKey, id, ...inputData } = input.event.inputConfig;
