...
// Input schema for Create Integration Configurations Keys
...
// Output schema for Create Integration Configurations Keys
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Create Integration Configurations Keys",
  description: "Creates create integration configurations keys in LaunchDarkly",
