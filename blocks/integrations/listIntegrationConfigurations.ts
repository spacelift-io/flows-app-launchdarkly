...
// Input schema for List Integration Configurations
...
// Output schema for List Integration Configurations
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "List Integration Configurations",
  description: "Retrieves list integration configurations in LaunchDarkly",
