...
// Input schema for Update Integration Configurations
...
// Output schema for Update Integration Configurations
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  ...
  description: "Updates update integration configurations in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { integrationConfigurationId, ...inputData } =
