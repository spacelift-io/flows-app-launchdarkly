...
// Input schema for Get Code Refs Repositories2
...
// Output schema for Get Code Refs Repositories2
const outputSchema = {
  type: "object",
  properties: {
    name: {
...
export default {
  name: "Get Code Refs Repositories2",
  description: "Retrieves get code refs repositories2 in LaunchDarkly",
