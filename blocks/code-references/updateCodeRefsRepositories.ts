...
// Input schema for Update Code Refs Repositories
...
// Output schema for Update Code Refs Repositories
const outputSchema = {
  type: "object",
  properties: {
    name: {
...
export default {
  name: "Update Code Refs Repositories",
  description: "Updates update code refs repositories in LaunchDarkly",
