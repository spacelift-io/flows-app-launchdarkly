...
// Input schema for Get Code Refs Repositories Branches2
...
// Output schema for Get Code Refs Repositories Branches2
const outputSchema = {
  type: "object",
  properties: {
    name: {
...
export default {
  name: "Get Code Refs Repositories Branches2",
  description: "Retrieves get code refs repositories branches2 in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { repo, branch } = input.event.inputConfig;
