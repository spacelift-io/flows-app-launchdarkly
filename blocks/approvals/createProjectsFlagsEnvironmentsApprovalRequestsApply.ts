...
// Input schema for Create Projects Flags Environments Approval Requests Apply
...
// Output schema for Create Projects Flags Environments Approval Requests Apply
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Create Projects Flags Environments Approval Requests Apply",
  description:
    "Creates create projects flags environments approval requests apply in LaunchDarkly",
  category: "Approvals",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/projects/${projectKey}/flags/${featureFlagKey}/environments/${environmentKey}/approval-requests/${id}/apply`;
