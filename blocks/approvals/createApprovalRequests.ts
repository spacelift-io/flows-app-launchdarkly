...
// Input schema for Create Approval Requests
...
// Output schema for Create Approval Requests
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  ...
  description: "Creates create approval requests in LaunchDarkly",
  category: "Approvals",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/approval-requests`;
