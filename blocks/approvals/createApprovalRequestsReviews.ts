...
// Input schema for Create Approval Requests Reviews
...
// Output schema for Create Approval Requests Reviews
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Create Approval Requests Reviews",
  description: "Creates create approval requests reviews in LaunchDarkly",
  category: "Approvals",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/approval-requests/${id}/reviews`;
