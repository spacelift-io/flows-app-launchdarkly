...
// Input schema for Update Projects Flags Environments Approval Requests
...
// Output schema for Update Projects Flags Environments Approval Requests
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Update Projects Flags Environments Approval Requests",
  description:
    "Updates update projects flags environments approval requests in LaunchDarkly",
  category: "Approvals",
