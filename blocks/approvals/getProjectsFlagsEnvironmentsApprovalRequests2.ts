...
// Input schema for Get Projects Flags Environments Approval Requests2
...
// Output schema for Get Projects Flags Environments Approval Requests2
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Get Projects Flags Environments Approval Requests2",
  description:
    "Retrieves get projects flags environments approval requests2 in LaunchDarkly",
  category: "Approvals",
