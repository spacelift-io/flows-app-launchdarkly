...
// Input schema for Get Projects Flags Environments Workflows
...
// Output schema for Get Projects Flags Environments Workflows
const outputSchema = {
  type: "object",
  properties: {
    items: {
...
export default {
  name: "Get Projects Flags Environments Workflows",
  description:
    "Retrieves get projects flags environments workflows in LaunchDarkly",
  category: "Workflows",
