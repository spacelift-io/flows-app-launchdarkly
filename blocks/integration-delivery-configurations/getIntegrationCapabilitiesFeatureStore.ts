...
// Input schema for Get Integration Capabilities Feature Store
const inputSchema: Record<string, AppBlockConfigField> = {};

// Output schema for Get Integration Capabilities Feature Store
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Integration Capabilities Feature Store",
  description:
    "Retrieves get integration capabilities feature store in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/integration-capabilities/featureStore`;
