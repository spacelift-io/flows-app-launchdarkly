...
// Input schema for Create Integration Capabilities Feature Store
...
// Output schema for Create Integration Capabilities Feature Store
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Create Integration Capabilities Feature Store",
  description:
    "Creates create integration capabilities feature store in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/integration-capabilities/featureStore/${projectKey}/${environmentKey}/${integrationKey}`;
