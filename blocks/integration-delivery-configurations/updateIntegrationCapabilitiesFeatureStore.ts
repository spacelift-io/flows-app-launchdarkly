...
// Input schema for Update Integration Capabilities Feature Store
...
// Output schema for Update Integration Capabilities Feature Store
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Update Integration Capabilities Feature Store",
  description:
    "Updates update integration capabilities feature store in LaunchDarkly",
