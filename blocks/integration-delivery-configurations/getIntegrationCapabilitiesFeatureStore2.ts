...
// Input schema for Get Integration Capabilities Feature Store2
...
// Output schema for Get Integration Capabilities Feature Store2
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Integration Capabilities Feature Store2",
  description:
    "Retrieves get integration capabilities feature store2 in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/integration-capabilities/featureStore/${projectKey}/${environmentKey}`;
