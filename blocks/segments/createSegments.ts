...
// Input schema for Create Segments
...
// Output schema for Create Segments
const outputSchema = {
  type: "object",
  properties: {
    name: {
...
export default {
  ...
  description: "Creates create segments in LaunchDarkly",
  category: "Segments",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/segments/${projectKey}/${environmentKey}`;
