...
// Input schema for Get Segments Users
...
// Output schema for Get Segments Users
const outputSchema = {
  type: "object",
  properties: {
    userKey: {
...
export default {
  name: "Get Segments Users",
  description: "Retrieves get segments users in LaunchDarkly",
  category: "Segments",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { projectKey, environmentKey, segmentKey, userKey } =
          input.event.inputConfig;
        const endpoint = `/api/v2/segments/${projectKey}/${environmentKey}/${segmentKey}/users/${userKey}`;
