...
// Input schema for Get Segments Expiring User Targets
...
// Output schema for Get Segments Expiring User Targets
const outputSchema = {
  type: "object",
  properties: {
    items: {
...
export default {
  name: "Get Segments Expiring User Targets",
  description: "Retrieves get segments expiring user targets in LaunchDarkly",
  category: "Segments",
