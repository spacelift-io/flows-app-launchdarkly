...
// Input schema for Get Oauth Clients2
...
// Output schema for Get Oauth Clients2
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Oauth Clients2",
  description: "Retrieves get oauth clients2 in LaunchDarkly",
