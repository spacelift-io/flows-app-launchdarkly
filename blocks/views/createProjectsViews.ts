...
// Input schema for Create Projects Views
...
// Output schema for Create Projects Views
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Create Projects Views",
  description: "Creates create projects views in LaunchDarkly",
  category: "Views",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/projects/${projectKey}/views`;
