...
// Input schema for Get Projects View Associations
...
// Output schema for Get Projects View Associations
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Projects View Associations",
  description: "Retrieves get projects view associations in LaunchDarkly",
  category: "Views",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { projectKey, resourceType, resourceKey } =
          input.event.inputConfig;
        const endpoint = `/api/v2/projects/${projectKey}/view-associations/${resourceType}/${resourceKey}`;
