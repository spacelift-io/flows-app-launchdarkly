...
// Input schema for Get Projects Views Linked
...
// Output schema for Get Projects Views Linked
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Projects Views Linked",
  description: "Retrieves get projects views linked in LaunchDarkly",
  category: "Views",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/projects/${projectKey}/views/${viewKey}/linked/${resourceType}`;
