...
// Input schema for Update Projects Views
...
// Output schema for Update Projects Views
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Update Projects Views",
  description: "Updates update projects views in LaunchDarkly",
  category: "Views",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { projectKey, viewKey, ...inputData } = input.event.inputConfig;
