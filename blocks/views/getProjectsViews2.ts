...
// Input schema for Get Projects Views2
...
// Output schema for Get Projects Views2
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Projects Views2",
  description: "Retrieves get projects views2 in LaunchDarkly",
  category: "Views",
