...
// Input schema for Get Projects Views
...
// Output schema for Get Projects Views
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Projects Views",
  description: "Retrieves get projects views in LaunchDarkly",
  category: "Views",
