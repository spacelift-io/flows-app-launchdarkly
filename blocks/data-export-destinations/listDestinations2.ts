...
// Input schema for List Destinations2
...
// Output schema for List Destinations2
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "List Destinations2",
  description: "Retrieves list destinations2 in LaunchDarkly",
