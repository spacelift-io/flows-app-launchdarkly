...
// Input schema for Update Destinations
...
// Output schema for Update Destinations
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  ...
  description: "Updates update destinations in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { projectKey, environmentKey, id, ...inputData } =
