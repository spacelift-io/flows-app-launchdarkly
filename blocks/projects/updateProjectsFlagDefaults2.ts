...
// Input schema for Update Projects Flag Defaults2
...
// Output schema for Update Projects Flag Defaults2
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Update Projects Flag Defaults2",
  description: "Updates update projects flag defaults2 in LaunchDarkly",
  category: "Projects",
