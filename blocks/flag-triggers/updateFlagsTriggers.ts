...
// Input schema for Update Flags Triggers
...
// Output schema for Update Flags Triggers
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Update Flags Triggers",
  description: "Updates update flags triggers in LaunchDarkly",
