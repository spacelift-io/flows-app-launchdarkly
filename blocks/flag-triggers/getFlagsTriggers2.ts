...
// Input schema for Get Flags Triggers2
...
// Output schema for Get Flags Triggers2
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Get Flags Triggers2",
  description: "Retrieves get flags triggers2 in LaunchDarkly",
