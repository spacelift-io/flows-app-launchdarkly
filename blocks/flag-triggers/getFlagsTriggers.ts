...
// Input schema for Get Flags Triggers
...
// Output schema for Get Flags Triggers
const outputSchema = {
  type: "object",
  properties: {
    items: {
...
export default {
  name: "Get Flags Triggers",
  description: "Retrieves get flags triggers in LaunchDarkly",
