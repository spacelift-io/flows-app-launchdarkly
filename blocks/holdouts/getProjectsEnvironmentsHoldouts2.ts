...
// Input schema for Get Projects Environments Holdouts2
...
// Output schema for Get Projects Environments Holdouts2
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Get Projects Environments Holdouts2",
  description: "Retrieves get projects environments holdouts2 in LaunchDarkly",
  category: "Holdouts",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { projectKey, environmentKey, holdoutKey } =
