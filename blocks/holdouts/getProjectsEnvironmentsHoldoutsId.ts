...
// Input schema for Get Projects Environments Holdouts Id
...
// Output schema for Get Projects Environments Holdouts Id
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Get Projects Environments Holdouts Id",
  description:
    "Retrieves get projects environments holdouts id in LaunchDarkly",
  category: "Holdouts",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { projectKey, environmentKey, holdoutId } =
          input.event.inputConfig;
        const endpoint = `/api/v2/projects/${projectKey}/environments/${environmentKey}/holdouts/id/${holdoutId}`;
