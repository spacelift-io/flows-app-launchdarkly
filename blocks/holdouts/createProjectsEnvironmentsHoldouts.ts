...
// Input schema for Create Projects Environments Holdouts
...
// Output schema for Create Projects Environments Holdouts
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Create Projects Environments Holdouts",
  description: "Creates create projects environments holdouts in LaunchDarkly",
  category: "Holdouts",
