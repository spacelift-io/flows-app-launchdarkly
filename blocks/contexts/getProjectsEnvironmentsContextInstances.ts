...
// Input schema for Get Projects Environments Context Instances
...
// Output schema for Get Projects Environments Context Instances
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Projects Environments Context Instances",
  description:
    "Retrieves get projects environments context instances in LaunchDarkly",
  category: "Contexts",
