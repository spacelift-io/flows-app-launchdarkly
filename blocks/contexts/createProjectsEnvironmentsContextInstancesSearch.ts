...
// Input schema for Create Projects Environments Context Instances Search
...
// Output schema for Create Projects Environments Context Instances Search
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Create Projects Environments Context Instances Search",
  description:
    "Creates create projects environments context instances search in LaunchDarkly",
  category: "Contexts",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/projects/${projectKey}/environments/${environmentKey}/context-instances/search`;
