...
// Input schema for Create Projects Environments Contexts Search
...
// Output schema for Create Projects Environments Contexts Search
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Create Projects Environments Contexts Search",
  description:
    "Creates create projects environments contexts search in LaunchDarkly",
  category: "Contexts",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/projects/${projectKey}/environments/${environmentKey}/contexts/search`;
