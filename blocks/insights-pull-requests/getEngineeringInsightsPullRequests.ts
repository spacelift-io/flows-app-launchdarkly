...
// Input schema for Get Engineering Insights Pull Requests
...
// Output schema for Get Engineering Insights Pull Requests
const outputSchema = {
  type: "object",
  properties: {
    totalCount: {
...
export default {
  name: "Get Engineering Insights Pull Requests",
  description:
    "Retrieves get engineering insights pull requests in LaunchDarkly",
  category: "Insights pull requests",

  inputs: {
    default: {
      config: inputSchema,
      onEvent: async (input: EventInput) => {
        const endpoint = `/api/v2/engineering-insights/pull-requests`;
