...
// Input schema for Create Projects Environments Experiments Iterations
const inputSchema: Record<string, AppBlockConfigField> = {
  ...
  treatments: {
    ...
    type: {
      ...
      items: {
        ...
        required: ["name", "baseline", "allocationPercent", "parameters"],
      },
    },
    required: true,
  },
  ...
  primarySingleMetricKey: {
    name: "Primary Single Metric Key",
    description:
...
// Output schema for Create Projects Environments Experiments Iterations
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Create Projects Environments Experiments Iterations",
  description:
    "Creates create projects environments experiments iterations in LaunchDarkly",
