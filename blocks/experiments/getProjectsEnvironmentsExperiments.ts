...
// Input schema for Get Projects Environments Experiments
...
// Output schema for Get Projects Environments Experiments
const outputSchema = {
  type: "object",
  properties: {
    items: {
...
export default {
  name: "Get Projects Environments Experiments",
  description:
    "Retrieves get projects environments experiments in LaunchDarkly",
