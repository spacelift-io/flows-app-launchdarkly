...
// Input schema for Get Projects Environments Experiments2
...
// Output schema for Get Projects Environments Experiments2
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Get Projects Environments Experiments2",
  description:
    "Retrieves get projects environments experiments2 in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { projectKey, environmentKey, experimentKey } =
