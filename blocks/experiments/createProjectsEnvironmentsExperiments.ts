...
// Input schema for Create Projects Environments Experiments
const inputSchema: Record<string, AppBlockConfigField> = {
  ...
  iteration: {
    ...
    type: {
      ...
      required: ["hypothesis", "metrics", "treatments", "flags"],
      description: "Details on the construction of the initial iteration",
    },
    required: true,
  },
...
// Output schema for Create Projects Environments Experiments
const outputSchema = {
  type: "object",
  properties: {
    _id: {
...
export default {
  name: "Create Projects Environments Experiments",
  description:
    "Creates create projects environments experiments in LaunchDarkly",
