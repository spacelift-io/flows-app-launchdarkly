...
// Input schema for Update Projects Flags Release Phases
...
// Output schema for Update Projects Flags Release Phases
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Update Projects Flags Release Phases",
  description: "Updates update projects flags release phases in LaunchDarkly",
  category: "Releases",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { projectKey, flagKey, phaseId, ...inputData } =
          input.event.inputConfig;
        const endpoint = `/api/v2/projects/${projectKey}/flags/${flagKey}/release/phases/${phaseId}`;
