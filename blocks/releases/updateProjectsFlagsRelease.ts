...
// Input schema for Update Projects Flags Release
...
// Output schema for Update Projects Flags Release
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Update Projects Flags Release",
  description: "Updates update projects flags release in LaunchDarkly",
  category: "Releases",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/projects/${projectKey}/flags/${flagKey}/release`;
