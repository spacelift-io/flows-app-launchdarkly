...
// Input schema for Update Flag Links Projects Flags
...
// Output schema for Update Flag Links Projects Flags
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Update Flag Links Projects Flags",
  description: "Updates update flag links projects flags in LaunchDarkly",
  category: "Flag links",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { projectKey, featureFlagKey, id, ...inputData } =
