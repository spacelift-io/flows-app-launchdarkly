...
// Input schema for Update Projects Release Pipelines
...
// Output schema for Update Projects Release Pipelines
const outputSchema = {
  type: "object",
  properties: {
    createdAt: {
...
export default {
  name: "Update Projects Release Pipelines",
  description: "Updates update projects release pipelines in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { projectKey, pipelineKey, ...inputData } =
