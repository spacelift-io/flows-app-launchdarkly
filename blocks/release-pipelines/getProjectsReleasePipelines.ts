...
// Input schema for Get Projects Release Pipelines
...
// Output schema for Get Projects Release Pipelines
const outputSchema = {
  type: "object",
  properties: {
    items: {
...
export default {
  name: "Get Projects Release Pipelines",
  description: "Retrieves get projects release pipelines in LaunchDarkly",
