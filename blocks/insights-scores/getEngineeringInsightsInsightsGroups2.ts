...
// Input schema for Get Engineering Insights Insights Groups2
...
// Output schema for Get Engineering Insights Insights Groups2
const outputSchema = {
  type: "object",
  properties: {
    environment: {
...
export default {
  name: "Get Engineering Insights Insights Groups2",
  description:
    "Retrieves get engineering insights insights groups2 in LaunchDarkly",
