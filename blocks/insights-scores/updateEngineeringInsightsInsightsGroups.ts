...
// Input schema for Update Engineering Insights Insights Groups
...
// Output schema for Update Engineering Insights Insights Groups
const outputSchema = {
  type: "object",
  properties: {
    environment: {
...
export default {
  name: "Update Engineering Insights Insights Groups",
  description:
    "Updates update engineering insights insights groups in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        const { insightGroupKey, ...inputData } = input.event.inputConfig;
