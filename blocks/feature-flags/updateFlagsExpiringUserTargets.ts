...
// Input schema for Update Flags Expiring User Targets
...
// Output schema for Update Flags Expiring User Targets
const outputSchema = {
  type: "object",
  properties: {
    items: {
...
export default {
  name: "Update Flags Expiring User Targets",
  description: "Updates update flags expiring user targets in LaunchDarkly",
