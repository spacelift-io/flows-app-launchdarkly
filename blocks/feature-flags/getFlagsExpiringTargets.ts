...
// Input schema for Get Flags Expiring Targets
...
// Output schema for Get Flags Expiring Targets
const outputSchema = {
  type: "object",
  properties: {
    items: {
...
export default {
  name: "Get Flags Expiring Targets",
  description: "Retrieves get flags expiring targets in LaunchDarkly",
