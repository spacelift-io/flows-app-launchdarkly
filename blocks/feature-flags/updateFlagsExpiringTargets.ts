...
// Input schema for Update Flags Expiring Targets
...
// Output schema for Update Flags Expiring Targets
const outputSchema = {
  type: "object",
  properties: {
    items: {
...
export default {
  name: "Update Flags Expiring Targets",
  description: "Updates update flags expiring targets in LaunchDarkly",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input: EventInput) => {
        ...
        const endpoint = `/api/v2/flags/${projectKey}/${featureFlagKey}/expiring-targets/${environmentKey}`;
