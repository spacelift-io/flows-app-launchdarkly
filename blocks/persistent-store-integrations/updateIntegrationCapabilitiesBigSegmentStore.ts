...
// Input schema for Update Integration Capabilities Big Segment Store
...
// Output schema for Update Integration Capabilities Big Segment Store
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Update Integration Capabilities Big Segment Store",
  description:
    "Updates update integration capabilities big segment store in LaunchDarkly",
