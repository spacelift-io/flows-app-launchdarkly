...
// Input schema for Get Integration Capabilities Big Segment Store2
...
// Output schema for Get Integration Capabilities Big Segment Store2
const outputSchema = {
  type: "object",
  properties: {
    _links: {
...
export default {
  name: "Get Integration Capabilities Big Segment Store2",
  description:
    "Retrieves get integration capabilities big segment store2 in LaunchDarkly",
